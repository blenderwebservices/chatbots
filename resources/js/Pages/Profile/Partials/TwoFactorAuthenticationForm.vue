...
<template>
  <ActionSection>
    ...
    <template #content>
      ...
      <div
        class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400"
      >
        <p>
          When two factor authentication is enabled, you
          will be prompted for a secure, random token during
        ...
        <div v-if="recoveryCodes.length > 0 && !confirming">
          ...
          >
            <p class="font-semibold">
              ...
              password manager. They can be used to recover
              access to your account if your two factor
