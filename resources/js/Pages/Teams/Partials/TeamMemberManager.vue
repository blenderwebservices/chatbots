...
const addTeamMember = () => {
  addTeamMemberForm.post(
    route('team-members.store', props.team),
    {
  ...
  <div>
    <div v-if="userPermissions.canAddTeamMembers">
      ...
      <FormSection @submitted="addTeamMember">
        ...
        <template #description>
          Add a new team member to your team, allowing them
    ...
    >
      ...
      <ActionSection class="mt-10 sm:mt-0">
        ...
        <template #description>
          These people have been invited to your team and
          have been sent an invitation email. They may join
