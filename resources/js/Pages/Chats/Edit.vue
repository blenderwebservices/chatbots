    ...
    >
      ...
      >
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 my-4">
          ...
          <!-- Execution Status -->
          <div v-if="executionStatus !== 'idle'" class="mt-4 flex items-center gap-2 text-sm font-medium" :class="{
            'text-blue-600 dark:text-blue-400': executionStatus === 'running',
            'text-green-600 dark:text-green-400': executionStatus === 'success',
            'text-red-600 dark:text-red-400': executionStatus === 'error',
          }">
            <template v-if="executionStatus === 'running'">
